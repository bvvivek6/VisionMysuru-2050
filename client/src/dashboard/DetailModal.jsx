    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
        <motion.div
          ...
          className="relative max-h-[95vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-[var(--surface)] "
        >
          <div className="sticky top-0 z-10  bg-[var(--surface)] px-6 py-4 flex items-center justify-between">
            <div>
              ...
              <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-[var(--muted)]">
                <span className="font-mono rounded bg-[var(--bg)] px-2 py-0.5">
                  {submission.teamId}
                </span>
                <span>•</span>
                ...
                <span>•</span>
                <span className="rounded bg-[var(--accent)]/10 px-2 py-0.5 text-[var(--accent)] font-semibold">
            ...
            <button
              onClick={onClose}
              className="rounded-xl p-2 text-white bg-red-600 hover:bg-[var(--bg)] hover:text-red-500 transition"
