    ...
    <Section id="about" eyebrow="About" title="About Mysuru Vision 2050">
      <div className="grid gap-6 lg:grid-cols-12 lg:items-stretch">
        <div className="lg:col-span-7">
          <div className=" py-3 md:py-6">
            <p className="text-sm leading-relaxed text-[var(--muted)]">
              Mysuru Vision 2050 is not just an event; it is a city-wide
              movement. Bridging the gap between academic theory and civic
              reality, this initiative transforms students into “City
              Consultants”. Over a 60-day rapid innovation cycle, participants
              will identify ground-level bottlenecks and propose scalable
              solutions.
            </p>
        ...
        <div className="lg:col-span-5">
          <div className="relative h-100 overflow-hidden  sm:h-full">
            <img
              src="/about.jpg"
              alt="Mysuru city"
